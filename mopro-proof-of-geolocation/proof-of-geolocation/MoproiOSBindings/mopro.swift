...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_proof_of_geolocation_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_proof_of_geolocation_rustbuffer_free(self, $0) }
    }
}
...
private func makeRustCall<T, E: Swift.Error>(
    ...
    uniffiEnsureProofOfGeolocationInitialized()
...
public func generateCircomProof(zkeyPath: String, circuitInputs: String, proofLib: ProofLib)throws  -> CircomProofResult  {
    ...
    uniffi_proof_of_geolocation_fn_func_generate_circom_proof(
...
public func generateHalo2Proof(srsPath: String, pkPath: String, circuitInputs: [String: [String]])throws  -> Halo2ProofResult  {
    ...
    uniffi_proof_of_geolocation_fn_func_generate_halo2_proof(
...
public func generateNoirProof(circuitPath: String, srsPath: String?, inputs: [String])throws  -> Data  {
    ...
    uniffi_proof_of_geolocation_fn_func_generate_noir_proof(
...
public func moproUniffiHelloWorld() -> String  {
    ...
    uniffi_proof_of_geolocation_fn_func_mopro_uniffi_hello_world($0
    )
})
}
public func verifyCircomProof(zkeyPath: String, proofResult: CircomProofResult, proofLib: ProofLib)throws  -> Bool  {
    ...
    uniffi_proof_of_geolocation_fn_func_verify_circom_proof(
        FfiConverterString.lower(zkeyPath),
...
public func verifyHalo2Proof(srsPath: String, vkPath: String, proof: Data, publicInput: Data)throws  -> Bool  {
    return try  FfiConverterBool.lift(try rustCallWithError(FfiConverterTypeMoproError_lift) {
    uniffi_proof_of_geolocation_fn_func_verify_halo2_proof(
        FfiConverterString.lower(srsPath),
...
public func verifyNoirProof(circuitPath: String, proof: Data)throws  -> Bool  {
    return try  FfiConverterBool.lift(try rustCallWithError(FfiConverterTypeMoproError_lift) {
    uniffi_proof_of_geolocation_fn_func_verify_noir_proof(
        FfiConverterString.lower(circuitPath),
...
private let initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_proof_of_geolocation_uniffi_contract_version()
    if bindings_contract_version != scaffolding_contract_version {
        return InitializationResult.contractVersionMismatch
    }
    if (uniffi_proof_of_geolocation_checksum_func_generate_circom_proof() != 14754) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_proof_of_geolocation_checksum_func_generate_halo2_proof() != 15653) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_proof_of_geolocation_checksum_func_generate_noir_proof() != 45165) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_proof_of_geolocation_checksum_func_mopro_uniffi_hello_world() != 12126) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_proof_of_geolocation_checksum_func_verify_circom_proof() != 47171) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_proof_of_geolocation_checksum_func_verify_halo2_proof() != 51177) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_proof_of_geolocation_checksum_func_verify_noir_proof() != 54790) {
        return InitializationResult.apiChecksumMismatch
    }
...
public func uniffiEnsureProofOfGeolocationInitialized() {
